    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If proofid <> "" AndAlso layout > 0 AndAlso fileName <> "" Then
            Try
                ...
                Dim mimeType As String = "image/" & System.IO.Path.GetExtension(fileName).Replace(".", "")
                ...
                Dim fs As System.IO.FileStream = New System.IO.FileStream(truePath, System.IO.FileMode.Open, System.IO.FileAccess.Read)
